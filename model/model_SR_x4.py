...
from sota_models.BDT.bidirection import *
...
class Bidinet(nn.Module):
    def __init__(self, args):
        ...
        # self.args = args
        self.img_size = 256     # reduce-256
        print(self.img_size)
        self.in_channels = args.msi_channel
        self.embed_dim = 48  # w-msa
        self.dim = 48  # w-xca
        self.t = Merge(img_size=self.img_size, patch_size=1, in_chans1=self.in_channels+1, in_chans2=self.in_channels, embed_dim=self.embed_dim, num_heads1=[8, 8, 8], window_size=8, group=8,  mlp_ratio=4.,dim=self.dim,
