...
class Full_Dataset_Pro(data.Dataset):
    def __init__(self, file_path):
        super(Full_Dataset_Pro, self).__init__()
        data = h5py.File(file_path)
